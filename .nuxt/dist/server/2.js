...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/index.vue?vue&type=template&id=177979db&
...
// CONCATENATED MODULE: ./pages/article/index.vue?vue&type=template&id=177979db&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/components/article-meta.vue?vue&type=template&id=e73faa1a&
var article_metavue_type_template_id_e73faa1a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"article-meta"},[_c('nuxt-link',{attrs:{"to":{
      name: 'profile',
      params: {
...
var article_metavue_type_template_id_e73faa1a_staticRenderFns = []


// CONCATENATED MODULE: ./pages/article/components/article-meta.vue?vue&type=template&id=e73faa1a&
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  article_metavue_type_template_id_e73faa1a_render,
  article_metavue_type_template_id_e73faa1a_staticRenderFns,
  false,
  injectStyles,
  null,
  "789ddff0"
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/components/article-comments.vue?vue&type=template&id=205584ef&
var article_commentsvue_type_template_id_205584ef_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<form class=\"card comment-form\"><div class=\"card-block\"><textarea placeholder=\"Write a comment...\" rows=\"3\" class=\"form-control\">"+_vm._ssrEscape(_vm._s(_vm.content))+"</textarea></div> <div class=\"card-footer\"><img"+(_vm._ssrAttr("src",_vm.article.author.image))+" class=\"comment-author-img\"> <button class=\"btn btn-sm btn-primary\">Post Comment</button></div></form> "),_vm._l((_vm.comments),function(comment){return _vm._ssrNode("<div class=\"card\">","</div>",[_vm._ssrNode("<div class=\"card-block\"><p class=\"card-text\">"+_vm._ssrEscape(_vm._s(comment.body))+"</p></div> "),_vm._ssrNode("<div class=\"card-footer\">","</div>",[_c('nuxt-link',{staticClass:"comment-author",attrs:{"to":{
          name: 'profile',
          params: {
        ...
        }}},[_vm._v("\n        "+_vm._s(comment.author.username)+"\n      ")]),_vm._ssrNode(" <span class=\"date-posted\">"+_vm._ssrEscape(_vm._s(_vm._f("date")(comment.createdAt,'MMM DD, YYYY')))+"</span> "+((_vm.isCurrentUser)?("<span class=\"mod-options\"><i class=\"ion-trash-a\"></i></span>"):"<!---->"))],2)],2)})],2)}
var article_commentsvue_type_template_id_205584ef_staticRenderFns = []


// CONCATENATED MODULE: ./pages/article/components/article-comments.vue?vue&type=template&id=205584ef&
...
/* harmony default export */ var article_commentsvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async destroy(id) {
      await Object(api_article["d" /* deleteComments */])(this.article.slug, id);
    }
...
var article_comments_component = Object(componentNormalizer["a" /* default */])(
  ...
  article_commentsvue_type_template_id_205584ef_render,
  article_commentsvue_type_template_id_205584ef_staticRenderFns,
  false,
